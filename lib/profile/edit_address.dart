...
class _EditAddressState extends State<EditAddress> {
  ...
  String address_name = '', address = '', user_id = '';
  ...
  getAddress() async {
    final response = await http.post(Uri.parse(UserUrl.detailAddress), body: {
      "id": widget.id.toString(),
    });

    final data = jsonDecode(response.body);
    String address_nameAPI = data['address_name'];
    String addressAPI = data['address'];

    setState(() {
      addressNameController.text = address_nameAPI;
  ...
  saveAddress() async {
    await getPref();
    final response = await http.post(Uri.parse(UserUrl.updateAddress), body: {
      "id": widget.id.toString(),
